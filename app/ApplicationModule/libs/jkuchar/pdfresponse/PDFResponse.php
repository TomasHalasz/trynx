...
class PdfResponse implements \Nette\Application\IResponse {
	 ...
	 * @var string
	 */
	public $pageMargins = "5,5,5,5,9,9";
    ...
    /**
     * After document is send to output or save to file
     * @var callback
     */
    public $onAfterComplete = array();
	...
	public function makePDF(){
        ...
        //TH 26.07.2019
        //send PDF to Output like always
        $mpdf->Output($this->outputName,$this->outputDestination);
        //send PDF to location according settings
        //bdump($this->outputDestination);
        if ($tmpMakeFile && $this->outputDestination != 'F') {
            $mpdf->Output($this->outputName, 'F');
        }
