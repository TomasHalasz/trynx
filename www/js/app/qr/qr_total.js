...
qrcode.debug = false;
qrcode.maxImgSize = (1684*3)*(1684*3);//1024*1024; 1190
    ...
    else
    {
        ...
        image.onload=function(){
            ...
            if(canvas_out!=null)
            {
                ...
                //outctx.drawImage(image, 0, 0, 320, 240);1190x1684
                outctx.clearRect(0, 0, 1190, 1684);
                outctx.drawImage(image, 0, 0, 1190, 1684);	
	    ...
	    //console.log(qrcode.maxImgSize);
            if(image.width*image.height>qrcode.maxImgSize)
            {
                var ir = image.width / image.height;
                nheight = Math.sqrt(qrcode.maxImgSize/ir);
                nwidth=ir*nheight;
		console.log('Source Image is too big');
            }
...
function FinderPatternFinder()
{
	...
	this.handlePossibleCenter=function( stateCount,  i,  j)
		{
			...
			//console.log('ceneterJ'+centerJ);
			//console.log('ceneterI'+centerI);
			if (!isNaN(centerI))
			{
				// Re-cross check
	...
	this.findFinderPattern = function(image){
		//24.08.2018 - solution for some kind of invoices in pdf like from ITS Office
		var tryHarder = true;
		this.image=image;
		var maxI = qrcode.height;
		var maxJ = qrcode.width;
