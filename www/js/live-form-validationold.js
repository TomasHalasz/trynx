...
var LiveForm = {
	options: {
		// CSS class of control's parent where error/valid class should be added; or "false" to use control directly form-group
		...
		controlErrorClass: 'form-control-error has-error',

		// CSS class for a valid control
		controlValidClass: 'has-success',

		// CSS class for an error message text-danger
		messageErrorClass: 'form-error help-block',
...
LiveForm.addError = function(el, message) {
	...
	//25.04.2016 - T.Halasz - nahrazeno popoverem
	//var messageEl = this.getMessageElement(el);
	//messageEl.innerHTML = message;
	//messageEl.className = this.options.messageErrorClass;
	
	var myObj = $('#'+el.id);
	if (myObj.hasClass('chzn-select'))
	{
		strEl = el.id;
		myObj = $('#'+strEl.replace(/-/g,'_')+'_chosen');
	}
	timeoutID = window.setTimeout(function(e){
		myObj.popover({content: message,placement: 'bottom', toggle: 'popover', html: 'true'});	    
		myObj.popover('show');	
